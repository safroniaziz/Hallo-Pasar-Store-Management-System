...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/pace/pace.min.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-lg" style="font-size:18px;"><b>HalloPasar</b> Bengkulu </span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        HalloPasar Bengkulu
        <small>Layanan Pesan Antar Sayur & Sembako Online</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> HalloPasar</a></li>
  ...
  <footer class="main-footer ">
    <div class="pull-right hidden-xs">
      <a href="" target="_blank"><b>HalloPasar Bengkulu</b></a>
    </div>
    <strong>Copyright &copy; 2022 <a href="">HalloPasar
  </footer>
