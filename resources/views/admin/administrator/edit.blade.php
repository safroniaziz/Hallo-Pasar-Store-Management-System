    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-edit"></i>&nbsp;Edit Data Administrator</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <form action="{{ route('admin.administrator.update',[$administrator->id]) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-6 ">
                            <label>Nama Administrator</label>
                            <input type="text" name="nama_user" value="{{ $administrator->nama_user }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <select name="jenis_kelamin" class="form-control" id="">
                                ...
                                <option value="L" @if ($administrator->jenis_kelamin == "L")
                                    selected
                                @endif>Laki-Laki</option>
                                <option value="P" @if ($administrator->jenis_kelamin == "P")
                                    selected
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="pekerjaan" value="{{ $administrator->pekerjaan }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            <label for="">Tanggal Lahir</label>
                             <div class="input-group date">
                                ...
                                <input type="text" name="tanggal_lahir" value="{{ $administrator->tanggal_lahir }}" class="form-control pull-right date" autocomplete="off">
                            </div>
                            <div>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="no_hp" value="{{ $administrator->no_hp }}" class="form-control">
                            <div>
                                @if ($errors->has('no_hp'))
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <textarea name="alamat" id="" cols="30" rows="3" class="form-control">{{ $administrator->alamat }}</textarea>
                            <div>
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('admin.administrator') }}" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
