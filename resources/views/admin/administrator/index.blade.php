    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-users"></i>&nbsp; Data Administrator</h3>
                <div class="pull-right">
                    <a href="{{ route('admin.administrator.create') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                            ...
                            <tbody>
                                @foreach ($administrators as $index=> $administrator)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($administrator->jenis_kelamin == "L")
                                        ...
                                        <td>{{ $administrator->pekerjaan }}</td>
                                        <td>{{ $administrator->tanggal_lahir }}</td>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('admin.administrator.edit',[$administrator->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                    </td>
                                                    <td>
                                                        <form action="{{ route('admin.administrator.delete',[$administrator->id]) }}" method="POST">
