    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-plus"></i>&nbsp;Tambah Data Administrator</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <form action="{{ route('admin.administrator.post') }}" method="post" enctype="multipart/form-data">
