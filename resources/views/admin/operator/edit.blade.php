    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-edit"></i>&nbsp;Edit Data Operator</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <form action="{{ route('admin.operator.update',[$operator->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="nama_user" value="{{ $operator->nama_user }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <select name="jenis_kelamin" class="form-control" id="">
                                ...
                                <option value="L" @if ($operator->jenis_kelamin == "L")
                                    selected
                                @endif>Laki-Laki</option>
                                <option value="P" @if ($operator->jenis_kelamin == "P")
                                    selected
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="pekerjaan" value="{{ $operator->pekerjaan }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            <label for="">Tanggal Lahir</label>
                             <div class="input-group date">
                                ...
                                <input type="text" name="tanggal_lahir" value="{{ $operator->tanggal_lahir }}" class="form-control pull-right date" autocomplete="off">
                            </div>
                            <div>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="no_hp" value="{{ $operator->no_hp }}" class="form-control">
                            <div>
                                @if ($errors->has('no_hp'))
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <textarea name="alamat" id="" cols="30" rows="3" class="form-control">{{ $operator->alamat }}</textarea>
                            <div>
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('admin.operator') }}" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
