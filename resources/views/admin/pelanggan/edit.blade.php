                ...
                <div class="row">
                    <form action="{{ route('admin.pelanggan.update',[$pelanggan->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text" name="nama_user" value="{{ $pelanggan->nama_user }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            <label for="">Tanggal Lahir</label>
                             <div class="input-group date">
                                ...
                                <input type="text" name="tanggal_lahir" value="{{ $pelanggan->tanggal_lahir }}" class="form-control pull-right date" autocomplete="off">
                            </div>
                            <div>
